...
activities = {
    ...
    "Basketball Team": {
        "description": "Skill development and league play for basketball enthusiasts",
    ...
    "Art Club": {
        ...
        "max_participants": 18,
        "participants": ["chloe@mergington.edu", "grace@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Debate Club": {
        "description": "Prepare for debates, learn public speaking and argumentation",
